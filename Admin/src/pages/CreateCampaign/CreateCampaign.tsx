...
function validateForm() {
    ...
    if (!coverFile) return "Selecione uma imagem para a campanha.";
...
async function handleCreateCampaign() {
    ...
    try {
        ...
        const coverImage = await uploadCampaignCover(
            coverFile!,
            category,
            title
        );
        ...
        show({
            ...
            message: "A campanha foi cadastrada com sucesso.",
        });
...
useEffect(() => {
    ...
    const savedForm =
        sessionStorage.getItem("createCampaignForm");
    ...
    try {
        ...
        setTopicOne(data.topicOne ?? "");

        setTopicTwo(data.topicTwo ?? "");

        setTopicThree(data.topicThree ?? "");
        ...
        <section className="create-campaign">
            ...
            <div className="create-campaign-header">
                ...
                <div>
                    ...
                    <p>
                        Cadastre uma nova campanha de arrecadação.
                    </p>
            ...
            <LoadingModal
                    ...
                    description="Aguarde enquanto salvamos todas as informações da campanha."
                />
